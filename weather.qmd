...
##density of variables (už je v ggpairs)
# weather %>%
...
numeric_cols <- sapply(weather_capped, is.numeric)
for(col_name in names(weather_capped)[numeric_cols]) {
  boxplot(weather_capped[[col_name]],
          main = paste(col_name),
          ylab = col_name,
          col = "lightblue",
          border = "darkblue")
